const lunchExtraLabel = {
  de: "Extras",
  en: "Extras",
  ar: "إضافات",
};

const lunchOptionLabel = {
  de: "Auswahl",
  en: "Selection",
  ar: "اختيار",
};

const bakedPotatoExtras = [
  {
    id: "hummus",
    name: { de: "Hummus", en: "Hummus", ar: "حمص" },
    price: 0,
  },
  {
    id: "cream-cheese",
    name: { de: "Frischkäse", en: "Cream Cheese", ar: "جبنة كريمية" },
    price: 0,
  },
  {
    id: "guacamole",
    name: { de: "Guacamole", en: "Guacamole", ar: "غواكامولي" },
    price: 0,
  },
];

const fattoushExtras = [
  {
    id: "falafel",
    name: { de: "4 Falafel", en: "4 Falafel", ar: "4 حبات فلافل" },
    price: 3,
  },
];

const levanteOptions = [
  {
    id: "mild",
...
const lunch = [
  {
    ...
    items: [
...

      {
        ...
        subtitle: {
          de: "Wählen Sie Hummus, Frischkäse oder Guacamole.",
          en: "Choose hummus, cream cheese or guacamole.",
          ar: "اختر حمص أو جبنة كريمية أو غواكامولي.",
        },
        price: 8.0,
...

      {
        ...
        subtitle: {
          de: "Reis, Linsen, Nudeln, Kichererbsen, Tomatensoße und Röstzwiebeln. Nur am Wochenende.",
          en: "Rice, lentils, pasta, chickpeas, tomato sauce and crispy onions. Only on weekends.",
